...
- Sources examined: `crates/host-runtime/src/transport_provider.rs:70-88` (the
  `Candidate` contract), `:150-172` (the registry and its `Default`), `:302-332`
  (`memory_candidate`, the test-only constructor);
  `crates/host-runtime/src/shm_provider.rs:287-397` (`prepare`, including the worker
  thread at `:319-373` and what `Candidate.io` actually is at `:383-385`),
  `:460-544` (`run_endpoint`), `:546-620` (`receive_one`);
  `crates/host-runtime/src/connection.rs:1041-1096`, `:1130-1199`, `:196-236`,
  `:263-290`; `crates/host-runtime/src/config.rs:284`, `:297`;
  `crates/host-runtime/src/runtime.rs:870`. Repo-wide `grep -rn "Candidate {"
  crates/host-runtime/src/`, which finds exactly two constructors - `shm_provider.rs:389`

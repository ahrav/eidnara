...
`crates/host-runtime/src/connection.rs` declares both maps on `GenerationCore`, two lines apart:
...
- Sources examined: `grep -rn "pings.lock\|\.pings\b"` and `grep -rn "pending.lock\|PendingKey"`
  across `crates/host-runtime/src/`; `crates/host-runtime/src/connection.rs:500-540`;
  `crates/host-runtime/src/dispatch.rs:892-899`, `:1074-1075`, `:1456-1457`.
...
- Sources examined: `crates/host-runtime/src/connection.rs:500-511`.

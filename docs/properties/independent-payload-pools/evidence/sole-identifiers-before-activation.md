...
- `crates/host-runtime/src/ring_transport.rs:1455`
- `packages/shm-native/src/lib.rs:306`

Witness status: yes - `crates/shm-transport/tests/contract.rs:167`, `crates/shm-transport/src/backend/ring.rs:3061`, `crates/shm-transport/tests/profile.rs:261`, and `stale_wire_or_descriptor_schema_is_invalid_identity` in `crates/host-runtime/src/setup_socket.rs`.

...
| AC7 | 7 | `search_projection_rebuild_missing_db_after_prune`, `search_projection_rebuild_quiet_window_admitted`, `search_projection_healthy_lagged_target_admitted`, `search_projection_authorized_recovery_current_observed`, `search_projection_pending_full_next_commit`, `search_projection_embedding_restart_has_stable_pending_and_service`, `search_projection_embedding_retryable_failure_precedes_recovery` |
| AC8 | 3 | `search_projection_embedding_query_arrives_during_backfill_saturation`, `search_projection_embedding_stop_occurs_with_native_work_held`, `search_projection_embedding_budget_crosses_between_stages` |
...
| T6 | 4 | `search_projection_export_oversize_row_present`, `search_projection_export_page_budget_edge`, `search_projection_pending_full_next_commit`, `search_projection_complete_commit_over_cap` |
...
| T8 | 4 | `search_projection_embedding_pending_rediscovered_after_descriptor_loss`, `search_projection_embedding_query_arrives_during_backfill_saturation`, `search_projection_embedding_stop_occurs_with_native_work_held`, `search_projection_embedding_budget_crosses_between_stages` |
| T9 | 6 | `search_projection_rebuild_missing_db_after_prune`, `search_projection_rebuild_quiet_window_admitted`, `search_projection_healthy_lagged_target_admitted`, `search_projection_authorized_recovery_current_observed`, `search_projection_embedding_restart_has_stable_pending_and_service`, `search_projection_embedding_retryable_failure_precedes_recovery` |

//! Broca application protocol: request and event schemas the harness adapters exchange with
//! the daemon, validated with the same strict-decoding rules as the Synapse protocol.

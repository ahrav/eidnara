...
`derive_history_summarizer_chunk_tokens` computes one quarter of the context limit, rounds
...
`history_summarizer_budget_derivation_clamps_at_both_bounds` (`config.rs:1449-1455`)
...
The [pre-refresh evidence](https://github.com/ahrav/eidnara/blob/74044960ee91641dec95c8552f15282844a18b13/docs/properties/daemon/decisions/evidence/dec-a-derive-history_summarizer-chunk-tokens-is-total-at-both-integer-extremes.md)

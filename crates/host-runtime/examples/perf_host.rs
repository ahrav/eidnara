...
use host_runtime::{
    BindOutcome, CancellationToken, HealthReport, HostConfig, HostHandler, HostInit, InitError,
    ManifestSnapshot, RequestCtx, RequestOutcome, RouteHandle, RouteIdentity,
};
...
async fn main() {
    ...
    let mut config = HostConfig {
        ...
        daemon_ver: "eidnara-host/perf".to_owned(),
        ..Default::default()
    };

...
The document's side, `docs/host-wire-protocol.md:562`:
...
The code's side, `crates/host-runtime/src/connection.rs:500-540`. The arm's only
...
- Sources examined: `docs/host-wire-protocol.md:560-562` and `:651`;

 ...
 *
 *
 * Eidnara uses historian-driven compartments instead of `pi.compact()`.
 ...
 *      historian.
 * Pi's compaction lives in the session JSONL file, whereas the daemon stores compartments scoped by `sessionId`.
 */

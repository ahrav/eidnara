...
function createSidebarController(initialPrefs: EidnaraTuiPrefs): SidebarController {
    const [prefs, setPrefs] = createSignal<EidnaraTuiPrefs>(initialPrefs);
    const seedCollapsed =
        ...
        <box width="100%" flexDirection="column">
            ...
            {!props.collapsed && (
                <box flexDirection="column" marginTop={0}>
                    ...
                    <text fg={props.theme.textMuted}>
                        * includes Reasoning; hygiene excludes it
                    </text>
                </box>
            )}
        </box>
...
const SidebarContent = (props: {
    ...
    return (
        ...
        >
            ...
            {/* biome-ignore lint/a11y/noStaticElementInteractions: opentui `box` is a terminal layout node, not a DOM element. */}
            <box
                flexDirection="row"
                justifyContent="space-between"
                alignItems="center"
            ...
            {s() && s()!.inputTokens > 0 && (
                <box marginTop={collapsed() ? 0 : 1} flexDirection="column">
                    ...
                    {!collapsed() && (
                        <text fg={props.theme.textMuted}>
                            Conversation includes reasoning estimates; hygiene excludes reasoning.
                        </text>
                    )}
...
export function createSidebarContentSlot(
    api: TuiPluginApi,
): TuiSlotPlugin & { dispose: () => void } {

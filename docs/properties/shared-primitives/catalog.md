...
Confidence: high - [evidence](evidence/read-callbacks-cannot-write.md). `CallbackScope::read_only` (`crates/storage/src/lib.rs:445-457`) sets `query_only` and installs `deny_scope_escapes` (`crates/storage/src/lib.rs:587-646`); `GuardedConn` (`crates/storage/src/lib.rs:249-361`) omits the escapes; `unfenced_connection_rejects_writes` (`crates/storage/src/lib.rs:3131-3154`), `a_read_callback_cannot_clear_the_read_only_guard` (`crates/storage/src/lib.rs:3257-3305`), and `maintenance_runs_through_the_unfenced_path` (`crates/storage/src/lib.rs:3517-3530`) pin the three denials.

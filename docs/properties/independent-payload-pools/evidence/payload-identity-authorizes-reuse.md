...
- `crates/shm-transport/src/backend/ring.rs:1084`
- `crates/shm-transport/src/backend/retained.rs:606`
- `crates/shm-transport/src/descriptor.rs:222`

Witness status: yes - `crates/shm-transport/src/backend/ring.rs:2441` and `crates/shm-transport/src/backend/ring.rs:2363`; `crates/shm-transport/tests/contract.rs:118` covers the pure validator.

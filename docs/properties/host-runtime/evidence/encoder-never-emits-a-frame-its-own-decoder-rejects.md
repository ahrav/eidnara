...
`docs/host-wire-protocol.md:293` for the peer's obligation. That line is blank
...
`docs/host-wire-protocol.md:296`, retires the connection without
...
- Missing evidence: none for the allocator. Not examined: whether any
  ...
  under `crates/host-runtime/src` returns `routing.rs:145`, `:351`, `:367`, `:424`,

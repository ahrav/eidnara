...
The obligation, `docs/host-wire-protocol.md:262`:
...
admission `Normal`, with priority unconstrained. `docs/host-wire-protocol.md:248`
...
- Sources examined: `client.rs:2073-2080` (the pure-header flag gate),
  `docs/host-wire-protocol.md:248` (the design intent that a conforming Ping's

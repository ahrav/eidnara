...
use daemon::curator::coordinator::{InvestigationError, proposal_target, resolve_descriptor};
use daemon::curator::selection::{MEMORY_CLASSES, PRODUCTION_SELECTION_OPEN};

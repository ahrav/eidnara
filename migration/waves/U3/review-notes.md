...
The wave landed as thirteen stacked pull requests instead of the four this
record was first written against: five for the transport and tokenizer (#18 to
#22, replacing #8) and eight for the host runtime, addon, catalogs, and this
record (#23 to #30, replacing #9, #10, #11). The receipt's source blobs and

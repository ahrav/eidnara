...
- `crates/shm-transport/src/backend/ring.rs:976`
- `crates/shm-transport/src/profile.rs:416`

Witness status: yes - `crates/shm-transport/src/backend/ring.rs:2179` and `crates/shm-transport/tests/profile.rs:107`.

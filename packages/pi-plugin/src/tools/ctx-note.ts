...
import { getLastIndexedOrdinal } from "@eidnara/opencode/features/context/message-index";
import {
...
import {
    ...
    DEFAULT_READ_LIMIT,
    paginateNewestFirst,
} from "@eidnara/opencode/tools/ctx-note/pagination";
            ...
            if (action === "write") {
                ...
                if (surfaceCondition) {
                    ...
                    if (dreamerEnabled !== true) {
                        return err(
                            "Error: Smart notes require dreamer to be enabled. Enable dreamer in eidnara.jsonc to use surface_condition.",
                        );
                    }

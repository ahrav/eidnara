...
- The hook is `crates/host-runtime/src/dispatch.rs:720-733`, installed as the frame's
...
- The wedge chain is exact. `runtime.rs:996` returns the accept loop only on
  ...
  refused at `crates/host-runtime/src/connection.rs:285` because `draining` is true. A

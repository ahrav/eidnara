...
the drain without another daemon call, so a lease held by in-flight work
expires instead of being released. Pi's status line shows pending or unconfirmed

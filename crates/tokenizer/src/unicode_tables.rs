...
/// `\p{L}` as sorted, disjoint, inclusive scalar-value ranges (677 ranges).
#[rustfmt::skip]
pub const LETTER: &[(u32, u32)] = &[
    ...
    (0x16FE3, 0x16FE3), (0x17000, 0x187F7), (0x18800, 0x18CD5), (0x18CFF, 0x18D08),
    ...
    (0x1E5D0, 0x1E5ED), (0x1E5F0, 0x1E5F0), (0x1E7E0, 0x1E7E6), (0x1E7E8, 0x1E7EB),
...
/// `\p{N}` as sorted, disjoint, inclusive scalar-value ranges (144 ranges).
#[rustfmt::skip]

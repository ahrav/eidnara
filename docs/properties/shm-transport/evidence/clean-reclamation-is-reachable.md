...
`docs/shm-transport.md:87` states "These are distinct outcomes and
...
| `MatrixBackend` | `crates/host-runtime/tests/shm_transport.rs:450` | integration-test double |
...
What now owns the obligation: nothing. `crates/host-runtime/src/ring_transport.rs:291`
...
`docs/shm-transport.md:87-90` still presents clean reclamation and

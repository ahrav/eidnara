...
use daemon::projection_gates::{
    ...
    CapabilityDisposition, CompressionRecord, Denial, EntryPoint, Gate, HARNESSES, HookGate,
    InvalidationIdentity, ManifestRefusal, ProjectionHook, REQUIRED_LIMITS, Renewal,
    ResourceEvidence, TRACE_STAGES, VECTOR_LIMITS,
};
...
use support::projection_gate::{empty_coverage, identity, passing_evaluator, test_binding};

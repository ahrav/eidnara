...
- `crates/shm-transport/src/lease.rs:198-206`, `:215-221` — the ring lease
...
(`crates/shm-transport/Cargo.toml:9-10`) and off for both consumers, since
...
- Sources examined: `backend/iceoryx.rs:319-355`, `:178-189`, and the whole file
  ...
  `crates/shm-transport/src/lease.rs:198-221`;

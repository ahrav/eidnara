...
Witness status: yes - `crates/shm-transport/src/backend/ring.rs:2708` and `crates/shm-transport/src/backend/ring.rs:2613`; `crates/shm-transport/tests/contract.rs:118` covers the pure validator.

...
| durable ledger recovery, receipts, atomic application | `crates/memory-store/tests/dreamer_ledger.rs`, `crates/kernel/tests/kernel_envelope.rs` (storage is Rust; a TypeScript storage suite is a Handoff item) |

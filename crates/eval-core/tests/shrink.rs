...
use eval_core::{
    ...
    FailurePredicate, History, Lane, MAX_OUTSTANDING_REPLAY_EFFECTS, MAX_REPLAY_ATTEMPTS,
    Minimality, NotEstablishedReason, Oracle, OracleRefused, Payload, ReplayEffects, ReplayOutcome,

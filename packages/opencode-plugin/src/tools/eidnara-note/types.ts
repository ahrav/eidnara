...
export type EidnaraNoteReadFilter = "all" | "active" | "pending" | "ready" | "dismissed";

export interface EidnaraNoteArgs extends ImitatedReducedArgs {
    action?: "write" | "read" | "dismiss" | "update";
    content?: string;
    surface_condition?: string;
    filter?: EidnaraNoteReadFilter;

...
| durable intent-ledger recovery and replay fencing | `crates/memory-store/tests/claim_intent_ledger.rs` (storage is Rust; a TypeScript storage suite is a Handoff item) |

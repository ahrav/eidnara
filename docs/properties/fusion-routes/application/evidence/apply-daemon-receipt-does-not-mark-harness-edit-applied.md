...
A daemon-side receipt could claim an edit the harness never applied.

## Timing windows and dependencies

A stale apply acknowledging after a newer forward.

## What a test must construct

A forwarded receipt and confirms with wrong or absent identities.

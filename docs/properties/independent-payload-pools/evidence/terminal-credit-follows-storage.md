...
- `crates/shm-transport/src/backend/ring.rs:1657`
...
`crates/shm-transport/src/backend/ring.rs:2588` publishes, releases, publishes
again into the same block, and shows `take_reclaimed` reporting nothing until the
second publication is released; `crates/host-runtime/src/ring_transport.rs:3669`

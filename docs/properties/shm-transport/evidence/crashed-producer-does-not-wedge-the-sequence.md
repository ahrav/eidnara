...
- `crates/shm-transport/src/backend/ring.rs:688-703` — the derivation and the
...
- `crates/host-runtime/src/ring_transport.rs:560-563` — worth recording as the *negative*
...
- Existing check: none, confirmed. The six kill-based tests in
  `crates/host-runtime/tests/shm_failure_modes.rs` (`:105`, `:150`, `:246`, `:282`,
...
(`crates/host-runtime/src/ring_transport.rs:586-590`) and `publish_owned` performs two
...
reservation across `fill.call(views)` (`packages/shm-native/src/lib.rs:751`), and
...
does not yet offer. `RoleProcess::kill` (`crates/host-runtime/tests/support/shm_process.rs:257-263`),
...
suspension point (`crates/host-runtime/src/ring_transport.rs:659-673`). So the new scenario
...
- Sources examined: `ring.rs:664-736` (`try_reserve`), `:1156-1164`
  ...
  `crates/host-runtime/src/ring_transport.rs:560-606`, `:659-673` (the custody
  ...
  `packages/shm-native/src/lib.rs:708-775`, `:705-760`, `:864-889`;
  `crates/host-runtime/tests/support/shm_process.rs:256-292`, `:644-757`.
...
- Missing evidence: none for the mechanism. What is untested rather than unknown is
  ...
  `crates/host-runtime/tests/shm_failure_modes.rs:358` suggests re-offering is guarded at

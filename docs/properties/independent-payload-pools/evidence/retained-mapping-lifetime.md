...
- `crates/host-runtime/src/ring_transport.rs:461`

Witness status: yes - `crates/shm-transport/src/lease.rs:606` (Miri) and `crates/shm-transport/src/backend/ring.rs:2815`.

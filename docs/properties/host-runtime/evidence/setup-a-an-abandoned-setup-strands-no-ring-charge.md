...
`crates/host-runtime/src/connection.rs`, the post-authentication sequence:
...
`host-shm-transport.md:21` states that active and quarantined charges are
...
`crates/host-runtime/tests/shm_failure_modes.rs:232-245`
...
- Missing evidence: `ring_transport.rs` and `crates/shm-transport/src/`.

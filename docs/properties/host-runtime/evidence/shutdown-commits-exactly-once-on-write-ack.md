...
- `crates/host-runtime/src/lifecycle.rs:1184-1187` is `ShutdownLatch`: a
...
- `crates/host-runtime/src/tcp_frame_channel.rs:345` moves `written` out of the
...
- In-crate tests: `lifecycle.rs:1885-1911`, `:1913-1954`, `:1956-1985`,
  `:1989-2001`. Integration tests: `crates/host-runtime/tests/lifecycle.rs:1400-1436`,

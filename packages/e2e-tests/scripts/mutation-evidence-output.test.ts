...
const BUN_FAILURE = [
    ...
    "Received: 0",
    "",
    "      at <anonymous> (/local/home/someone/scratch/eidnara/packages/e2e-tests/tests/rust-eidnara-reduce-roundtrip.test.ts:133:26)",
    ...
    "(fail) rust eidnara_reduce round trip > queues the reduce row [412.43ms]",
    "",
    " 0 pass",
    " 1 fail",
    " 3 expect() calls",

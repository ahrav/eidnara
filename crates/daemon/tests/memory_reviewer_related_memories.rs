...
use daemon::memory_reviewer::related_memories::{
...
use kernel::{
    ...
    KernelStore, MAX_MEMORY_REVIEWER_HOLD_REFERENCES, MEMORY_REVIEWER_CAPTURE_RETENTION_CLASS,
    MemoryReviewerHoldBinding, ProviderEgress, ScopeSpec, ScopeTermSpec, Sensitivity,
...
impl Fixture {
    ...
    fn page(
        ...
        daemon::memory_reviewer::related_memories::RelatedPage,
        daemon::memory_reviewer::broker::Refusal,
    > {
...
fn hold_reference_limit_after_a_disclosure_marks_the_run_partial() {
    ...
    let anchors: Vec<String> = (0..MAX_MEMORY_REVIEWER_HOLD_REFERENCES - 1)
        .map(|index| {
            fixture

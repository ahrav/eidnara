...
const EXPECTED_OBJECTS: &[(&str, &str)] = &[
    ...
    ("index", "idx_history_segments_session_end_message"),
    ...
    ("index", "idx_memory_reviewer_frozen_selections_state"),
    ("index", "idx_memory_reviewer_jobs_pending"),
    ("index", "idx_memory_reviewer_jobs_state"),
    ("index", "idx_memory_reviewer_receipts_state"),
    ...
    ("table", "memory_capture_jobs"),
    ("table", "memory_classifier_attempts"),
    ("table", "memory_classifier_receipts"),
    ("table", "memory_reviewer_attempts"),
    ("table", "memory_reviewer_frozen_selections"),
    ("table", "memory_reviewer_jobs"),
    ("table", "memory_reviewer_receipts"),
    ("table", "memory_reviewer_selection_cursors"),
    ("table", "memory_reviewer_store_identity"),
    ...
    ("trigger", "memory_reviewer_jobs_reject_secret_insert"),
    ("trigger", "memory_reviewer_jobs_reject_secret_update"),
    ("trigger", "memory_reviewer_receipts_deadlines_immutable"),
    ("trigger", "memory_reviewer_receipts_no_delete"),
    ("trigger", "memory_reviewer_receipts_reject_secret_update"),
    (
        "trigger",
        "memory_reviewer_selection_cursors_reject_secret_insert",
    ),
    (
        "trigger",
        "memory_reviewer_selection_cursors_reject_secret_update",
    ),
    ("trigger", "memory_reviewer_store_identity_no_delete"),
    ("trigger", "memory_reviewer_store_identity_no_reinsert"),
    ("trigger", "memory_reviewer_store_identity_no_update"),

...
const EXPECTED_OBJECTS: &[(&str, &str)] = &[
    ...
    ("trigger", "curator_attempts_marker_immutable"),
    ("trigger", "curator_attempts_no_delete"),
    ("trigger", "curator_attempts_reject_secret_insert"),
    ("trigger", "curator_frozen_selections_reject_secret_insert"),

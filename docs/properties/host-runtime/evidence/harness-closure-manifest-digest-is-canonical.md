...
- **Existing evidence:** `canonical_manifest_digest_is_pinned` (renamed at U3 from a name that claimed cross-language agreement no test in this tree performs) and the strict-decode tests in `crates/host-runtime/tests/harness_closure.rs`.

...
- Sources examined: `crates/host-runtime/src/connection.rs:96-125`, `:142-236`,
  `:263-363`, `:452-464`, `:567-575`, `:900-915`;
  `crates/host-runtime/src/dispatch.rs:1371-1391`, `:1434-1452`;
  `crates/host-runtime/src/runtime.rs:130-140`, `:146-160`, `:418-436`, `:1010-1021`,
  `:1119-1177`; `crates/host-runtime/src/frame_channel.rs:800-826`, `:838-854`;
  repo-wide `grep -rn "connections" crates/host-runtime/src/` and `grep -rn
  "catch_unwind" crates/host-runtime/src/`.

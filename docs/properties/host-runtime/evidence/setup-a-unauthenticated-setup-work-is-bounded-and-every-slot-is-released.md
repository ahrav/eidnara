...
`docs/host-wire-protocol.md:161` states three MUSTs about unauthenticated
...
The bound is created at `crates/host-runtime/src/runtime.rs:913`:
...
Release, `crates/host-runtime/src/connection.rs`:
...
`docs/shm-transport.md:77` puts one connection's profile at 16
...
- Sources examined: `host-wire-protocol.md:161`, `connection.rs:140`.

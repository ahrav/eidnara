...
- Sources examined: `crates/host-runtime/src/dispatch.rs:143-168`, `:195-197`,
  `:262-270`, `:306-313`, `:503-573`, `:668-681`, `:686-700`, `:744-757`,
  `:1371-1391`, `:1434-1463`; `crates/host-runtime/src/frame_channel.rs:706-756`,
  `:760-831`; `crates/host-runtime/src/tcp_frame_channel.rs:313-404`;
  `crates/host-runtime/src/connection.rs:306-332`, `:418-464`, `:500-537`. Repo-wide
  `grep -n "is_cancelled\|token.cancelled" crates/host-runtime/src/dispatch.rs` (19

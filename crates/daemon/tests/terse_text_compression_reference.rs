//! Differential oracle for `daemon::terse_text_compression`.
//!
...
//!
//! Three copies of the transform exist: `terse_text_compression.rs`, `reference` below, and the frozen copy
//! in `terse_text_compression_differential.rs`. The golden fixture is generated from `terse_text_compression.ts`.
...
const LEVELS: [(
    TerseTextCompressionLevel,
    reference::TerseTextCompressionLevel,
    &str,
); 3] = [
    (
        TerseTextCompressionLevel::Lite,
        reference::TerseTextCompressionLevel::Lite,
        "lite",
    ),
    (
        TerseTextCompressionLevel::Full,
        reference::TerseTextCompressionLevel::Full,
        "full",
    ),
    (
        TerseTextCompressionLevel::Ultra,
        reference::TerseTextCompressionLevel::Ultra,
        "ultra",
    ),
];
...
fn reference_matches_golden_fixture() {
    ...
    for case in &cases {
        assert_eq!(
            reference::compress(&case.text, reference::TerseTextCompressionLevel::Lite),
            case.lite,
            "lite: {:?}",
            case.text
        );
        assert_eq!(
            reference::compress(&case.text, reference::TerseTextCompressionLevel::Full),
            case.full,
            "full: {:?}",
            case.text
        );
        assert_eq!(
            reference::compress(&case.text, reference::TerseTextCompressionLevel::Ultra),
            case.ultra,
            "ultra: {:?}",
            case.text
        );

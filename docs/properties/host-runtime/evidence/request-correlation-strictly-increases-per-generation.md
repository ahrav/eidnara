...
`docs/host-wire-protocol.md:750` is the contract, and it states the reason the host cannot rely
...
- Sources examined: `crates/host-runtime/src/connection.rs:465-480` read directly at HEAD.
...
- Sources examined: `crates/host-runtime/src/dispatch.rs:885-902`; `grep -rn "pending.lock"` across

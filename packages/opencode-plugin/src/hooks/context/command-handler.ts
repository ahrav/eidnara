...
import type { DreamerConfig, SidekickConfig } from "../../config/schema/eidnara";
...
import type { ManualRunResult } from "../../features/context/dreamer/task-scheduler";
import {
    executeClaimApprovalCommand,
    executeClaimEnforceCommand,
} from "../../features/context/memory/claim-policy-commands";
import { runSidekick } from "../../features/context/sidekick/agent";
import { getCompartments, getOrCreateSessionMeta } from "../../features/context/storage";
...
export function createEidnaraCommandHandler(deps: {
    ...
    getDreamerProgress?: () =>
        | import("../../features/context/dreamer/task-registry").DreamTaskProgress
        | null;

...
- Sources examined: `crates/host-runtime/src/frame_channel.rs:758-830` (every
  `FrameSender` method), `:706-756` (the state machine and ticket),
  `:838-854` (`SenderQueue`, which has no `Drop` impl);
  `crates/host-runtime/src/tcp_frame_channel.rs:303-400` (the whole writer loop);
  `crates/host-runtime/src/dispatch.rs:143-168`, `:195`, `:262-270`, `:306-313`,
  `:686-696`, `:1371-1391`; `crates/host-runtime/src/connection.rs:306-332`.

...
- **Existing evidence:** `open_pins_full_synchronous` (`crates/storage/src/lib.rs:1673`), `a_read_callback_cannot_lower_fence_durability` (`crates/storage/src/lib.rs:1707`).

...
`crates/daemon/src/historian.rs:326-334` rejects a mismatched chunk
...
historian firing eventually publishes.
...
Historian scheduling, failure backoff, and producer completion remain outside

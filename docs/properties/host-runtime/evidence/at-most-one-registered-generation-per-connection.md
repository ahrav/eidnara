...
- Sources examined: `crates/host-runtime/src/connection.rs:196-236` (the promote/reap
  branch), `:276-289` (registration), `:345-362` (close and handoff);
  `crates/host-runtime/src/runtime.rs:1119-1177` (the whole drain, including the
  Goodbye loop at `:1167-1169` and the token/rendezvous loops at `:1170-1175`);
  `crates/host-runtime/src/dispatch.rs:1371-1391` and `:1434-1452`
  (`send_connection_goodbye`); `crates/host-runtime/tests/lifecycle.rs:1715-1730`.

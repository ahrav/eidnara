...
use support::synapse::{
    BUDGET, DeterministicEngine, SynapseHost, batch_params, call, constraints, items,
    open_synapse_route, ready_component, request_key, send_call, sha256_hex, test_lane,
};

use host_runtime::synapse::{SynapseLimits, protocol};

const TY_ERROR: u8 = 5;

async fn spawn_query(
    host: &SynapseHost,
    lane: &host_runtime::synapse::LaneInfo,
    text: &str,
    deadline_ms: u64,

...
The contract, at `docs/host-wire-protocol.md:656`:
...
the namespace. `docs/host-wire-protocol.md:654` states the two directions are
...
- Sources examined: `docs/host-wire-protocol.md:654` ("A correlation MUST NOT be

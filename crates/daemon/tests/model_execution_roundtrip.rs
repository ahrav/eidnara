...
#[tokio::test]
async fn real_model_execution_success_block_release_failure_and_counters() {
...
#[tokio::test]
async fn real_model_execution_cancel_shutdown_and_full_route_handle_cleanup() {
    let fixture = FixtureProcess::start();
    let client = fixture.client().await;
    let route = fixture
        .open_route(

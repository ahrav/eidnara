...
Existing check: `open_claims_fence_before_return` (`crates/storage/src/lib.rs:2951-2966`), observes the claim before domain setup, and `open_claim_rejects_an_epoch_the_database_already_stores`, `:2733-2769`, pins the strict-advance rule at the helper rather than through two racing opens; status **unaudited**.

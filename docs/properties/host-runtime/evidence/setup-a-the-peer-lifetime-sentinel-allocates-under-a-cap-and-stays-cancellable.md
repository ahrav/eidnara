...
`crates/host-runtime/src/setup_socket.rs:355-367`:
...
`crates/host-runtime/src/connection.rs:196-206`:
...
`docs/shm-transport.md:49` says clean `Goodbye` and unexpected
...
3. assert no allocation of that size occurred. A resident-set delta is the
   practical oracle; `crates/host-runtime/tests/support/process_resources.rs`, used by

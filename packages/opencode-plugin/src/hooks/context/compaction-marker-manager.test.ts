...
import { createOpenCodeTestDb } from "../../features/context/test-database";
...
function useTempDataHome(prefix: string): string {
    ...
    mkdirSync(join(dir, "eidnara", "context"), { recursive: true });
    return dir;
}
...
describe("applyDeferredCompactionMarker — outcomes", () => {
    ...
    it("returns `retryable-failure` on raw OpenCode DB access errors", () => {
        ...
        mkdirSync(join(dataHome, "eidnara", "context"), { recursive: true });

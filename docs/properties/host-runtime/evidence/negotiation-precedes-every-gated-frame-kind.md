...
uncataloged. `docs/host-wire-protocol.md:560` states the obligation directly:
...
The readiness predicate is `transport_ready` at `crates/host-runtime/src/connection.rs:832-837`:
...
- Sources examined: `connection.rs:418-464` (the `Rejected` arm),
  ...
  `docs/host-wire-protocol.md:580`, `tests/transport_negotiation.rs:941-948`.

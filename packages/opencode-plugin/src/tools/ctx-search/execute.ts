...
import { getLastCompartmentEndMessage } from "../../features/context/compartment-storage";
import {
    embedTextForProject,
    getProjectEmbeddingSnapshot,
} from "../../features/context/memory/embedding";
import { resolveProjectRootDirectory } from "../../features/context/memory/project-identity";
import { type UnifiedSearchResult, unifiedSearch } from "../../features/context/search";
import {
    describeQueryBoundsViolation,
    normalizeSearchResultLimit,
} from "../../features/context/search-bounds";
import { getVisibleRevisionLocators } from "../../hooks/context/inject-compartments";
import { recordKernelMemoryRetrievals } from "../../hooks/context/kernel-claim-usage";
import {
    disabled,
    isAvailable,
    MAX_READ_OBJECT_IDS,

...
| `application/` | The preparation and receipt lifecycle behind `retrieval.prepare`, `retrieval.apply`, and `retrieval.confirm`, and the default-closed per-harness capability gate. | RP2.7.U4 ([#643](https://github.com/ahrav/eidnara/issues/643)); RP2.7.U5 ([#644](https://github.com/ahrav/eidnara/issues/644)). | Each part follows `../METHOD.md`. Records that a later ticket lands keep their

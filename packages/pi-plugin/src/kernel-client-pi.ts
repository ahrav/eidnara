...
} from "@eidnara/opencode/hooks/context/kernel-transport";
import { type KernelClientResolver, TokenCache } from "@eidnara/opencode/shared/kernel-client";
...
export function piSessionTokenCacheForTest(sessionId: string): TokenCache | undefined {

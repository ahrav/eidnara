...
| `history_summarizer_selected_range_identity_vector_was_empty_at_commit` | A predicate reached the fence with no recorded identities (`memory-store:9413-9417`) | Records the case the outright rejection exists for, without asserting an outcome |

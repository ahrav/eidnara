...
| U4 runtime input | `private-decode-input-stability`, `request-conversion-completion-ownership`, `reserved-publication-order` | - | landed |
...
| Gate integrity | `integration-gate-dependency-selection`, `unsafe-witness-selection`, `acceptance-artifact-provenance` | - | landed |

 ...
 * `HostClient.authenticated` reports null instead of a partial record when the handshake produces no daemon ID.
 */
...
export interface RequestOptions {
    ...
    timeoutMs?: number;
    /** The facade attaches `HostCallError.cleanup` when this signal aborts the request. */
    signal?: AbortSignal;

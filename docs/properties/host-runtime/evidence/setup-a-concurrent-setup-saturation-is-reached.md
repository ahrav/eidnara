...
- `crates/host-runtime/src/runtime.rs:913`,
...
The class-crossing interval, `crates/host-runtime/src/connection.rs:137-141`: the
...
- `crates/host-runtime/tests/lifecycle.rs:237`
  ...
  (`:273`).
- `crates/host-runtime/tests/lifecycle.rs:337`
...
`crates/host-runtime/tests/support/raw_client.rs:878` is documented at `:877` as being
...
`crates/host-runtime/tests/shm_failure_modes.rs:44-58` authenticates, calls
...
- Sources examined: `crates/host-runtime/tests/lifecycle.rs:237-275`, `:334-360`,

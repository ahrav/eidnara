...
(`crates/shm-transport/src/descriptor.rs:147`, length constant at `:12`) and
...
Host side. `decode_header` (`crates/host-runtime/src/wire.rs:311-373`) reads the
...
`docs/shm-transport.md:13` says the receiver "snapshots and validates

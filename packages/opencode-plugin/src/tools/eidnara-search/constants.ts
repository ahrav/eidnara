export const EIDNARA_SEARCH_TOOL_NAME = "eidnara_search";
export const EIDNARA_SEARCH_DESCRIPTION = `Your long-term recall for this project — search the project's durable memories, not just what's currently visible.
